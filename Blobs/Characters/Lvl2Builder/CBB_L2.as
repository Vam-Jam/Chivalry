...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
		BuildBlock b(0, "building1", "$building$", "Workshop\nStand in an open space\nand tap this button.");
	...
	{
		BuildBlock b(0, "oilmaker", "$building$", "Oil Maker\nConvert wood into oil!\n(Safety not guaranteed)");
	...
	{
		BuildBlock b(0, "brazier", "$building$", "Brazier\nSet nearby arrows on fire!\n(For people who like fire)");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 500);
		b.buildOnGround = true;
		b.size.Set(16, 8);
		blocks[0].insertAt(9, b);
