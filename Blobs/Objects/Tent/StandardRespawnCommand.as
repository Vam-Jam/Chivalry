...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Builder", "$builder_class_icon$", "builder0", "Build ALL the towers.");
	addPlayerClass(this, "Knight", "$knight_class_icon$", "builder1", "Hack and Slash.");
	addPlayerClass(this, "Archer", "$archer_class_icon$", "builder2", "The Ranged Advantage.");
}
...
void BuildRespawnMenuFor(CBlob@ this, CBlob @caller)
{
	...
	{
		CGridMenu@ menu = CreateGridMenu(caller.getScreenPos() + Vec2f(24.0f, caller.getRadius() * 1.0f + 48.0f), this, Vec2f(1 * CLASS_BUTTON_SIZE, CLASS_BUTTON_SIZE), getTranslatedString("Swap class"));
		if (menu !is null)
		{
