...
shared class CTFSpawns : RespawnSystem
{
	...
	void DoSpawnPlayer(PlayerInfo@ p_info)
	{
		if (canSpawnPlayer(p_info))
		{
			...
			//p_info.blob_name = "builder"+rules.get_u8(p_info.team+"TL");
			//p_info.blob_name = "builder0";//FOR DEBUG ONLY, comment this and uncomment the one above
...
shared class CTFCore : RulesCore
{
	...
	void AddPlayer(CPlayer@ player, u8 team = 0, string default_config = "")
	{
		...
		//TODO builder0 = team level, not team num
		CTFPlayerInfo p(player.getUsername(), team, "builder0");
		players.push_back(p);
